...
Here are the scripts used to perform analyses in the manuscripts entitled "A gene-based model of fitness and its implications for genetic variation: Linkage disequilibrium" (https://www.biorxiv.org/content/10.1101/2024.09.12.612686v2.abstract) and "A gene-based model of fitness and its implications for genetic variation: Genetic and inbreeding loads" (https://www.biorxiv.org/content/10.1101/2025.02.19.639162v1.abstract) by Parul Johri and Brian Charlesworth.\ 
