...
my_barplot <- barplot(data_mean , beside=T , legend.text=T,col=v_colors , ylab=expression(italic("L")), names.arg=epsilon_values, xlab="epistasis coefficient", cex.lab=2, cex.axis=1.5, ylim=c(0, y_max))
...
y_min <- min(c(t_sub_mean$additive_gene-t_sub_se$additive_gene,t_sub_mean$additive_site-t_sub_se$additive_site))
y_max <-max(c(t_sub_mean$additive_gene-t_sub_se$additive_gene,t_sub_mean$additive_site-t_sub_se$additive_site))
my_barplot <- barplot(data_mean , beside=T , legend.text=T,col=v_colors , ylab=expression(italic("B")), names.arg=epsilon_values, xlab="epistasis coefficient", cex.lab=2, cex.axis=1.5, ylim=c(y_min, y_max))
error.bar(my_barplot, data_mean, data_se)
...
y_min <- min(c(t_sub_mean$additive_gene-t_sub_se$additive_gene,t_sub_mean$additive_site-t_sub_se$additive_site))
y_max <-max(c(t_sub_mean$additive_gene-t_sub_se$additive_gene,t_sub_mean$additive_site-t_sub_se$additive_site))
my_barplot <- barplot(data_mean , beside=T , legend.text=T,col=v_colors , ylab=expression(paste(italic("B"), " (sample)")), names.arg=epsilon_values, xlab="epistasis coefficient", cex.lab=2, cex.axis=1.5, ylim=c(y_min, y_max))
error.bar(my_barplot, data_mean, data_se)
legend("topright", legend=c("gene", "sites"), col=v_colors, fill=v_colors, cex=1.5, box.lty=0)
title(main = expression(paste(italic("h"), "=0.0")), cex.main=2, adj=0)
...
y_min <- min(c(t_sub_mean$additive_gene-t_sub_se$additive_gene,t_sub_mean$additive_site-t_sub_se$additive_site))
y_max <-max(c(t_sub_mean$additive_gene-t_sub_se$additive_gene,t_sub_mean$additive_site-t_sub_se$additive_site))
my_barplot <- barplot(data_mean , beside=T , legend.text=T,col=v_colors , ylab=expression(paste(italic("B"), " (sample)")), names.arg=epsilon_values, xlab="epistasis coefficient", cex.lab=2, cex.axis=1.5, ylim=c(y_min, 0))
error.bar(my_barplot, data_mean, data_se)
title(main = expression(paste(italic("h"), "=0.5")), cex.main=2, adj=0)
